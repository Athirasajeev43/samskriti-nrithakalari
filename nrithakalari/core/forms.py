...
class RegisterForm(forms.Form):
    ...
    Note: Your current `views.register()` creates the User + UserProfile
    directly from `request.POST`. This form is provided mostly for clarity
...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = UserProfile
        fields = ["age", "phone", "address", "profile_image"]
